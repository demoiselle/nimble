...
class WizardContext {
    ...
    def propertyMissing(String name) { return attributes[name] }
	
	private static WizardContext instance = null
	
	private WizardContext() {
	}
	
	static WizardContext getDefault() {
		if (!instance)
			instance = new WizardContext()
		return instance
	}
