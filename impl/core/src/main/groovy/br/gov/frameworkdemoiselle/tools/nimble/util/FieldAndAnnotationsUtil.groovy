...
/**
 * 
 * Utility Class that represents a Field and Annotations from parsed java source file
 * 
 * @author Emerson Sachio Saito
 *
 */
class FieldAndAnnotationsUtil {

	private String fieldName

	private List<String> fieldAnnotations

	public FieldAndAnnotationsUtil (def fieldName, def fieldAnnotations){
